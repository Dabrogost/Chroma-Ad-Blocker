...
- If you configure a proxy, you are responsible for the proxy provider you choose and for any terms, logging, or routing behavior associated with that provider.
